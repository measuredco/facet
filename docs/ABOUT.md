...
![Flexible Visual Systems book spread](https://res.cloudinary.com/measuredco/image/upload/v1772543573/articles/facet/facet-article-fvs_bprhsz.jpg)
...
![The Corner and some related components](https://res.cloudinary.com/measuredco/image/upload/v1772543569/articles/facet/facet-article-corner_dhszrb.png)
...
![Original composition in a blog post](https://res.cloudinary.com/measuredco/image/upload/v1772540558/articles/facet/facet-article-blog-post_f6i4nb.png)
...
![Mark Webster artwork](https://res.cloudinary.com/measuredco/image/upload/v1772540574/articles/facet/facet-article-webster_ditx4o.png)
...
![Finished Facet UI screenshot](https://res.cloudinary.com/measuredco/image/upload/v1772540562/articles/facet/facet-article-app_jl9j0b.png)

Here’s some example images created with Facet’s Randomise and Shuffle functions.

With brand primary colours.

![Facet-generated image collage in primary brand blue](https://res.cloudinary.com/measuredco/image/upload/v1772540562/articles/facet/facet-collage-blue_pwolec.png)

With extended palettes.

![Facet-generated image collage using extended palettes](https://res.cloudinary.com/measuredco/image/upload/v1772540567/articles/facet/facet-collage-colors_rb0xuj.png)
